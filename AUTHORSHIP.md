...
Dated entries under `research_logs/` use the sign-off format in [`research_logs/AUTHORSHIP.md`](research_logs/AUTHORSHIP.md). This file is repository-level provenance.
