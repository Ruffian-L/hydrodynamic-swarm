...
## 2026-03-24 - Early Exit Optimization in Memory Splat Queries
...
**Action:** Implemented early-exit checks (e.g., `if scale.abs() < 1e-7 { continue; }`) to skip these expensive tensor operations when force contributions are negligible.
