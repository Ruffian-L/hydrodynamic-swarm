...
impl SwarmMatrix {
    ...
    pub async fn get_metrics(&self) -> SwarmMetrics {
        // ⚡ Bolt: Fetch necessary data from the first resource into local variables and explicitly drop its guard
        // before acquiring the next lock. This reduces lock contention and prevents concurrent deadlocks.
