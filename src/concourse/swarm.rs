...
impl SwarmMatrix {
    ...
    pub async fn get_metrics(&self) -> SwarmMetrics {
        // ⚡ Bolt: Fetch necessary data from cell and explicitly drop guard before acquiring next lock
        ...
        let (node_count, edge_count, edge_counts, delta_c) = {
            ...
            (cell.node_count(), cell.edges.len(), cell.get_edge_counts_vec(), cell.calculate_delta_c())
        };
