...
impl PrimeGovernor {
    ...
    async fn poll_viscosity(&mut self) -> SwarmResult<()> {
        ...
        // Update cognitive state and check Lyapunov stability
        let is_stable = {
            ...
            // ⚡ Bolt: Compute required read conditions while still holding the initial write lock guard
            // to eliminate redundant lock acquisition and context-switching overhead in the hot path.
