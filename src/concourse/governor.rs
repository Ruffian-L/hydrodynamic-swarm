...
impl PrimeGovernor {
    ...
    async fn poll_viscosity(&mut self) -> SwarmResult<()> {
        ...
        // Update cognitive state and check stability atomically
        let is_stable = {
            ...
            // ⚡ Bolt: Compute read condition while holding write lock to avoid unnecessary context
            // switching, lock contention, and race condition risks from dropping and re-acquiring
