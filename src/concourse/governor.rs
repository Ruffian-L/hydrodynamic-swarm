...
impl PrimeGovernor {
    ...
    async fn poll_viscosity(&mut self) -> SwarmResult<()> {
        ...
        // Update cognitive state and check Lyapunov stability in a single write lock
        // guard to avoid repeatedly acquiring the lock within this async sequence,
        // reducing severe lock contention and context-switching overhead.
        let is_stable = {
