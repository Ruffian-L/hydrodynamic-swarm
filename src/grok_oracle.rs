...
impl GrokOracle {
    pub fn new() -> Result<Self> {
        ...
        // 🛡️ Sentinel: Explicitly configure a 60-second timeout for the Grok HTTP client.
        // This prevents resource exhaustion and infinite hangs if the external API becomes unresponsive.
