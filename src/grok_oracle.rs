...
impl GrokOracle {
    pub fn new() -> Result<Self> {
        ...
        Ok(Self {
            // 🛡️ Sentinel: Network clients must have timeouts to prevent resource exhaustion and indefinite hangs
            client: Client::builder().timeout(std::time::Duration::from_secs(60)).build()?,
            api_key,
        })
    }
