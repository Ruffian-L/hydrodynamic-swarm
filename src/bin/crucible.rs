...
fn main() {
    ...
    // 🛡️ Sentinel: Validate `tokens` input to prevent path traversal
    // The tokens parameter is used to construct the log file path.
    // Ensure it contains only numeric digits before proceeding.
