...
fn main() {
    ...
    let binary_str = "target/release/hydrodynamic-swarm";
    // 🛡️ Sentinel: Construct absolute path using CARGO_MANIFEST_DIR to prevent command hijacking
    let binary_path = format!("{}/{}", env!("CARGO_MANIFEST_DIR"), binary_str);
